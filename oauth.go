...
func NewConfig(consumerKey, consumerSecret, accessToken, accessTokenSecret, version string) Config {
	return Config{
...
func (config Config) header() *oauthHeader {
	return &oauthHeader{
...
func (config Config) HashKey() string {
